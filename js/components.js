...
export function renderFooter(settings = {}, impactStats = []) {
  ...
  const clientsSection = activeClients.length > 0 ? `
    <div class="footer-clients" style="margin-top:4rem; width:100%; max-width:1200px; margin-left:auto; margin-right:auto;">
      <h4 style="color:rgba(255,255,255,0.6); font-size:0.8rem; margin-bottom:2rem; letter-spacing:0.15em; text-transform:uppercase;">${clientsTitle}</h4>
      <div class="footer-clients-grid">
        ${activeClients.map(c => {
